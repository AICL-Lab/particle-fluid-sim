...
2. **Understanding the implementation**: read [Core Architecture RFC](../openspec/specs/rfc/0001-core-architecture.md).
3. **Making changes**: read [Setup Guide](setup/README.md) and [Contributing](../CONTRIBUTING.md).
